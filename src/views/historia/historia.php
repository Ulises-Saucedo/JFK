...
<body>
      ...
      <div class="timeline-container" id="timeline-1">
        ...
        <div class="timeline">
          <div class="timeline-item" data-text="CREACIÓN DE ESCUELAS DE ARTES Y OFICIOS">
            <div class="timeline__content"><img class="timeline__img" src="fotos/pioneros.jpg"/>
          ...
          <div class="timeline-item" data-text="EXPANSIÓN DE LA ESCUELA">
            <div class="timeline__content"><img class="timeline__img" src="fotos/patio1945.jpg"/>
          ...
          <div class="timeline-item" data-text="NUEVA UBICACIÓN">
            <div class="timeline__content"><img class="timeline__img" src="fotos/ubi.jpg"/>
          ...
          <div class="timeline-item" data-text="CONVERSIÓN EN ESCUELA INDUSTRIAL">
            <div class="timeline__content"><img class="timeline__img" src="fotos/industrial.jpg"/>
          ...
          <div class="timeline-item" data-text="CREACIÓN Y APERTURA DEL ANEXO">
            <div class="timeline__content"><img class="timeline__img" src="fotos/eet1.jpg"/>
    ...
    <section>
      <div class="cont-pdf">
        <p>Accedé a nuestra historia completa mediante el siguiente enlace:</p>
        <a href="eet5_historia.pdf" target="blank">Historia completa</a>
      </div>
    </section>
    <footer>
