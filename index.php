                    ...
                    <div class="offcanvas-body">
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <li><a class="dropdown-item" href="./src/views/especialidades/electromecanica/electromecanica.php"><i class="bi bi-gear bi-ul-r"></i>Electromecánica</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item" href="./src/views/especialidades/informatica/informatica.php"><i class="bi bi-motherboard bi-ul-r"></i>Informática</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item" href="./src/views/especialidades/programacion/programacion.php"><i class="bi bi-laptop bi-ul-r"></i>Programación</a></li>
                                    </ul>
                                </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="./src/views/inscripcion/inscripcion.php"><i class="bi bi-file-earmark-text bi-ul-r"></i>Inscripción</a>
                            </li>
                            <li class="nav-item">
            ...
            <ul>
                ...
                <li class="specialties"><a href="#" class="toggle-icon"><i class="bi bi-caret-down bi-ul-r"></i>Especialidades</a>
                    <ul class="submenu animate__animated animate__fadeIn">
                        <li><a href="./src/views/especialidades/electromecanica/electromecanica.php"><i class="bi bi-gear bi-ul-r"></i>Electromecánica</a></li>
                        <li><a href="./src/views/especialidades/informatica/informatica.php"><i class="bi bi-motherboard bi-ul-r"></i>Informática</a></li>
                        <li><a href="./src/views/especialidades/programacion/programacion.php"><i class="bi bi-laptop bi-ul-r"></i>Programación</a></li>
                    </ul>
                </li>
                <li><a href="./src/views/inscripcion/inscripcion.php"><i class="bi bi-file-earmark-text bi-ul-r"></i>Inscripción</a></li>
    ...
    <section class="info__cards">
        <div class="card">
            ...
            <div class="card__button">
                <a class="noticias__texto" href="./src/views/foro/foro.php">
        ...
        <div class="card">
            ...
            <div class="card__button">
                <a class="noticias__texto" href="./src/views/inscripcion/inscripcion.php">
    ...
    <footer>
        <div class="footer__container">
            ...
            <div class="footer__box">
                ...
                <ul class="footer__ul">
                    <li class="footer__1er-item"><a href=".src/views/especialidades/programacion/programacion.php" target="_blank">Programación</a></li>
                    <li class="footer__1er-item"><a href=".src/views/especialidades/informatica/informatica.php" target="_blank">Informatica</a></li>
                    <li class="footer__1er-item"><a href=".src/views/especialidades/electromecanica/electromecanica.php" target="_blank">Electromecánica</a></li>
                </ul>
            </div>
            <div class="footer__box">
